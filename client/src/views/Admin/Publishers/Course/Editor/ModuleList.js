              ...
              <Box visibility={hovering ? "visible" : "hidden"}>
                <ListItemIcon>
                  <Tooltip arrow title="Delete Section">
                    <DeleteIcon
                      onClick={() =>
                        props.removeSection(props.moduleIndex, props.index)
                      }
                    />
                  </Tooltip>
                </ListItemIcon>
...
function Module(props) {
  ...
  return (
    <React.Fragment>
      ...
      <Collapse
        in={props.isModuleSelected(props.index)}
        timeout="auto"
        unmountOnExit
      >
        <SectionList
...
function ModuleList(props) {
  return (
    ...
    >
      <List
        component="nav"
        subheader={<ListSubheader component="div">Modules</ListSubheader>}
      >

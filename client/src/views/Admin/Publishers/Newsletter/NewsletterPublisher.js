      ...
      <div className={classes.center}>
        <Paper className={classes.container}>
          ...
          <Typography className={classes.heading}>
            Enter the email's subject, body, and any links to include in their
            respective fields. Once you you are ready to send, click the
            checkbox and press send.
          </Typography>
          <Grid container className={classes.textfield}>
            <form>
              ...
              />
              {failTry ? (
                <Typography color="primary" className={classes.failTry}>
              ...
              <Grid item>
                <FormControlLabel
                  control={
                    <Checkbox checked={checked} onChange={approveNewsletter} />
                  }
